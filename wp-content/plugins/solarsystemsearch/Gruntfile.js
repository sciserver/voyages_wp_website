...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      dev: {
        files: {
          'css/solarsystemsearch.css': [
		    'less/solarsystemsearch.less'
          ]
        },
        options: {
          compress: false
    ...
    uglify: {
      dist: {
        files: {
          'js/solarsystemsearch.min.js': [jsFileList]
        }
      }
    },
    ...
    postcss:{  
		...
		dev: {
			...
			src: 'css/solarsystemsearch.css'
		},
		build: {
			src: 'css/solarsystemsearch.min.css'
		}
	},
